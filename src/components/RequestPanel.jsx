        ...
        return (
            <div className="flex-1 flex items-center justify-center bg-gray-800 border-b border-gray-700">
                <div className="text-center text-gray-400">
                    ...
                    <p className="text-lg">
                        Selecciona una petición para empezar
                    </p>
                </div>
            </div>
        );
        ...
        <div className="flex-1 flex flex-col bg-gray-800 border-b border-gray-700 overflow-hidden">
            <div className="p-4 border-b border-gray-700">
                <div className="flex items-center gap-3 mb-3">
                    <span
                        className={`px-3 py-1 rounded font-semibold ${getMethodColor(selectedRequest.method)}`}
                    >
                        {selectedRequest.method}
                    </span>
                    <span className="text-gray-300 font-mono text-sm flex-1">
                        {selectedRequest.url.raw}
                    </span>
                    <button
                        onClick={onSend}
                        disabled={loading}
            ...
            <div className="flex-1 overflow-auto p-4">
                {selectedRequest.header &&
                    selectedRequest.header.length > 0 && (
                        <div className="mb-4">
                ...
                {(selectedRequest.body?.raw || requestBody) && (
                    <div>
                        ...
                        <p className="text-xs text-gray-500 mt-1">
                            💡 Este contenido se enviará como body de la
                            petición {selectedRequest.method}
                        </p>
                    </div>
                )}
            </div>
